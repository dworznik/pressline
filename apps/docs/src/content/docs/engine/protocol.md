...
- `aspect` is the design's own shape; Pressline hides Offers whose print area does not fit it, and your Engine answers 422 `aspect_mismatch` to a Spec it cannot honor.
