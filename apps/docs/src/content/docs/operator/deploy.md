...
After the first deploy the instance boots with an empty Catalogue and no secrets; [`pressline doctor`](/reference/cli/) tells you what is missing. Continue with [Configure](/operator/configure/).
