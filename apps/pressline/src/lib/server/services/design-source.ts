 ...
 * implementation is an HTTP client (ticket #5) over @pressline/contract's
 * EngineApi. Declared here so the runtime can be wired and tested with an
 * in-memory Engine from day one.
 */
